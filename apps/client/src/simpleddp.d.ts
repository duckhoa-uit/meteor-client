declare module "simpleddp" {
  ...
  export default class simpleDDP {
     ...
     */
    on(event: ddpEvent, callback: (e: any) => void): ddpEventListener
    /**
  ...
  type ddpEvent =
    ...
    | "loginResume"
    | "loginResumeFailed"
  export function on(event: ddpEvent, callback: () => void): ddpEventListener
  export function login(args: { user: { username?: string | null } }): void
}
